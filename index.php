...
<body>
    ...
    <?php include_once('elems/slider.php') ?>
    <?php include_once('elems/qt.php') ?>
    <?php include_once('elems/content.php') ?>
    <?php include_once('elems/clients.php') ?>
    <?php include_once('elems/footer.php') ?>
